...
const Ethics = () => {        
    return (
        <section id='about' className="py-12 bg-black/10 sm:py-16 lg:py-20">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            ...
            <p className="mt-4 text-base mx-auto leading-7 text-gray-600 max-w-[700px] sm:mt-8 font-pj"><span className='font-bold'>Siteswala</span> - the web development company that combines creativity, technical expertise, and customer-focused solutions to build a stunning, functional, and user-friendly website that drives results for your business.</p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            <div className="md:p-8 lg:p-14">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">We keep clear and transparent communication with clients to understand their requirements and expectations & also keep them updated on the progress of the project.</p>
            </div>

            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                <svg className="mx-auto" width="56" height="56" viewBox="0 0 372.483 372.483" fill="#000000" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Teamwork</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">We have a cohesive team that works together to achieve a common goal Also we encourage collaboration and support among team members.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Punctual</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Delivering each and every project within the agreed timeline without compromising on the quality of the work by prioritizing tasks and manage our workload effectively.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">We work closely with our clients to understand their business goals, target audience, and unique selling proposition. We then design, develop, and optimize their websites to deliver a seamless user experience that drives results.
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">Attentive to every detail of the project, so that the website is visually appealing, functional, responsive and SEO friendly. A good content strategy can help you improve your search engine rankings, establish your authority, and drive conversions.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">We have a culture of continuous learning and improvement, so that we stay up-to-date with the latest trends, tools, and technologies in the industry to deliver the best solutions to their clients.</p>
            </div>
        </div>
    </div>
</section>
